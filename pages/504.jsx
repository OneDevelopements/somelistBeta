            ...
            <div className="flex justify-center w-full">
                <div className="px-6 lg:px-36 max-w-4xl">
                    <div className="flex flex-col mt-20 justify-center text-center w-full">
                        <p className="text-8xl text-transparent bg-clip-text bg-gradient-to-bl to-sky-500 from-purple-600 font-semibold">504</p>
                            ...
                            <div onClick={() => router.back()} className="w-full hover:bg-zinc-500/5 px-6 my-2 hover:px-6 rounded-lg transition-all duration-200 cursor-pointer border border-black/5 dark:border-white/5 py-5 flex justify-between items-center">
                                <div className="flex gap-x-4">
                                    ...
                                    <div className="text-left mr-3">
                                        <p className="text-lg text-sky-500 dark:text-sky-200">Status</p>
