...
const ToggleSwitch = (props) =>{
    ...
    return(<div className="w-full flex items-center">
        <p>{props.label} {props.tooltip && <Tippy content={props.tooltip} placement='top'><i className="far fa-question-circle text-black/50 dark:text-white/50 hover:dark:text-white hover:text-black"></i></Tippy>}</p>
        <Switch
           checked={enabled}
           onChange={(e) => {
               setenabled(e)
           ...
           className={`${enabled ? 'bg-sky-600' : 'bg-gray-300 dark:bg-gray-900'}
